...
/***/ function(module, exports) {
	...
	var freshFiles = ['/', '/credits.html', '/js/main.js', '/css/base.css'];
	...
	self.addEventListener('fetch', function (_ref) {
		var request = _ref.request;

		// if in the static file cache, return

		var _ref2 = new URL(request.url);
		...
		if (freshFileLookup[pathname]) {
			return caches.open('fresh_files').then(function (freshCache) {
		...
		caches.open('static_files').then(function (staticCache) {
